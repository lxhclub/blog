...
--
-- Create schema lxh_blog
--

CREATE DATABASE IF NOT EXISTS lxh_blog;
USE lxh_blog;
...
INSERT INTO `admin` (`id`,`account`,`password`) VALUES 
 (1,'lxh','FDB390E945559E74475ED8C8BBB48CA5');
...
INSERT INTO `article` (`id`,`typeName`,`title`,`content`,`author`,`sendTime`,`visit`,`commend`) VALUES 
...
INSERT INTO `userinfo` (`id`,`account`,`password`,`realname`,`email`,`sex`,`tel`,`profession`,`address`,`homepage`,`qq`, `headgif`,`freeze`,`art_type`,`friend_type`,`commend`,`vistor`,`self`) VALUES 
 (1,'test','698D51A19D8A121CE581499D7B701668','测试','mr@163.com','男',1234,'软件工程师','不知','http://192.168.1.199:8080/22.1/test',1234, 'images/headgif/1.gif','解冻',
 '技术,笑话',' ','是',0,'斯蒂芬萨菲'),
 (2,'风轻云淡','698D51A19D8A121CE581499D7B701668','测试','mr@1126.com','男',1324,'不告诉你','不知道','http://192.168.1.199:8080/22.1/风轻云淡',2564, 'images/headgif/1.gif','解冻', 
' ',' ','是',0,'阿斯顿飞'),
 (3,'wgh','96E79218965EB72C92A549DD5A330112','wgh','wgh717@sohu.com','男',11111111,'程序员','长春市','http://192.168.1.66:8080/577/wgh',1111111111, 'images/headgif/6.gif','解冻',
 '','','否',0,'平平淡淡才是真！'),
 (4,'qq','698D51A19D8A121CE581499D7B701668','qiqi','wgh717@sohu.com','女',111111,'111','长春市','http://192.168.1.66:8080/577/qq',805342, 'images/headgif/4.gif','冻结',
 '','','否',0,'天天'),
 (5,'rty','202CB962AC59075B964B07152D234B70','345','rty@ert.fgf','男',345,'345345','345345','http://192.168.1.66:8080/577/rty',345, 'images/headgif/2.gif','冻结',
 '','','否',0,'345'),
 (6,'sss','202CB962AC59075B964B07152D234B70','dsa','ssss@163.com','男',123456,'sda','asd','http://192.168.1.66:8080/577/sss',123456, 'images/headgif/1.gif','冻结',
'','','否',0,'sdfsd'),
 (7,'mrwgh','698D51A19D8A121CE581499D7B701668','wanggh','wgh717@sohu.com','女',11111111,'程序员','长春市','http://localhost:8080/577/mrwgh',11111111, 'images/headgif/6.gif','解冻',
'随笔','','是',0,'平平淡淡才是真！'),
 (8,'cdd','96E79218965EB72C92A549DD5A330112','vdd','sdf@sdf.com','男',123123,'123','123','http://127.0.0.1:8080/blog/cdd',23123, 'images/headgif/1.gif','冻结',
'技术','','否',1,'123'),
 (9,'陈丹丹','96E79218965EB72C92A549DD5A330112','陈丹丹','sdf@sdf.com','女',12123,'sdf','sadf ','http://127.0.0.1:8080/blog/陈丹丹',12312, 'images/headgif/2.gif','解冻',
'技术','','否',3,'234');
