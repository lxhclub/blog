  		...
  		<li>
		  	<a href="#" onclick="test('menu2')">商品管理
		  		<div id="menu2" class="menu">
				  	 <a href="${pageContext.request.contextPath }/manager/GoodsServlet?method=addUI" target="right">添加商品</a><br/>
				  	 <a href="${pageContext.request.contextPath }/manager/GoodsServlet?method=list" target="right">查看商品</a>
			  	</div>
  			</a> 
  		</li>
  		<br/><br/>
