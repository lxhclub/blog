...
<body>
	<center>
		...
		<div id="wholePage">
			<div id="currentPoint">
				当前位置:&nbsp;&nbsp;<a class="green" href="allPostAction.action">首页</a>&nbsp;&nbsp;--&gt;&nbsp;&nbsp;管理问题
			</div>
			<ul class="singlePost">
			...
			<s:iterator value="personalQuestion" status="st">
				<ul class="singleQuestion">
					<li class="sequence">
						<s:property value="#st.getIndex()+1+(pageNumber-1)*pageSize"/>
					</li>
					<li class="topic">
						<a class="maroon" href="questionMatterAction.action?questionId=<s:property value="questionId"/>"><s:property value="topic"/></a>
					</li>
					<li class="author">
					...
					<li class="delete">
						<a href="deleteMyQuestionAction.action?postId=<s:property value="questionId"/>&pageNumber=<s:property value="pageNumber"/>">删除</a>
					</li>
				</ul>				
			</s:iterator>
			<ul class="singlePost">
