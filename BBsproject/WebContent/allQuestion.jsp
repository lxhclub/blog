		...
		<div id="wholePage">
				...
				<ul class="singleQuestion">
					...
					<li class="delete">
						<s:if test="%{#session.loginManager != null}">
							<a class="blue" href="deleteQuestionAction.action?questionId=<s:property value="postId"/>&pageNumber=<s:property value="pageNumber"/>">删除</a>
						</s:if>
						<s:else> ---- </s:else>
					</li>
				</ul>				
			...
			<ul class="singleQuestion">
				<li class="postPaging">
					...
					<a class="maroon" href="allQuestionAction.action?pageNumber=1">首页</a>
					<a class="maroon" href="allQuestionAction.action?pageNumber=<s:property value="pageNumber-1"/>">上一页</a>
					<a class="maroon" href="allQuestionAction.action?pageNumber=<s:property value="pageNumber+1"/>">下一页</a>
					<a class="maroon" href="allQuestionAction.action?pageNumber=<s:property value="totalPage"/>">末页</a>
				</li>
			</ul>
		</div>
