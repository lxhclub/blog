...
<body target="main">
<table width='99%' height="100%" border='0' cellspacing='0' cellpadding='0' background="image/bg.jpg">
  <tr>
	...
	<!-- Item 1 Strat -->
      ...
      <!-- Item 2 Strat -->
      <dl class='bitem'>
        <dt onClick='showHide("items2_1")'><b>系统日记</b></dt>
        <dd style='display:block' class='sitem' id='items2_1'>
          <ul class='sitemu'>
            <li><a onclick="javascript:void(0)" target='_blank'>系统日记待完善</a></li>
          </ul>
        </dd>
      </dl>
      <!-- Item 2 End -->
